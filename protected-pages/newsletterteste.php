    ...
    <main class="w-100 m-auto form-container">
        ...
        <form action="../php/newsletter-sender-all.php" method="post" id="newsletterform">
            ...
            <div class=" mb-3">
                ...
                <textarea class="form-control" name="corpoEmail" id="corpoEmaill" rows="15" cols="150" spellcheck="true" placeholder="Lorem ipsum..."></textarea>
            </div>
...
<script src="../vendor/ckeditor/sample/script.js"></script>
</body>
</html>